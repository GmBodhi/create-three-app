...
import vertexShaderRaw_ from "./shaders/vertexShaderRaw.glsl";
import fragmentShaderRaw_ from "./shaders/fragmentShaderRaw.glsl";
  ...
  loader.load("models/obj/ninja/ninjaHead_Low.obj", function (object) {
    object.traverse(function (child) {
      if (child.isMesh) {
        ...
        curvatureAttribute = new Float32Array(
          bufferGeo.attributes.position.count
        );
        ...
        bufferGeo.setAttribute(
          "curvature",
          new BufferAttribute(curvatureAttribute, 1)
        );
