...
// Global objects
//////////////////////////////
let worldScene = null; // Scene where it all will be rendered
let renderer = null;
let camera = null;
let clock = null;
const mixers = []; // All the AnimationMixer objects for all the animations in the scene
//////////////////////////////
...
const MODELS = [{ name: "Soldier" }, { name: "Parrot" }];
 ...
 * @param skinnedMesh {SkinnedMesh} The mesh to animate
 ...
 * @return {AnimationMixer} Mixer to be used in the render loop
 */
function startAnimation(skinnedMesh, animations, animationName) {
  const mixer = new AnimationMixer(skinnedMesh);
  const clip = AnimationClip.findByName(animations, animationName);
