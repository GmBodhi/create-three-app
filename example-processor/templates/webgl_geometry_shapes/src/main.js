...
function init() {
  ...
  function addShape(shape, extrudeSettings, color, x, y, z, rx, ry, rz, s) {
    ...
    let mesh = new Mesh(
      geometry,
      new MeshPhongMaterial({ side: DoubleSide, map: texture })
    );
    ...
    mesh = new Mesh(geometry, new MeshPhongMaterial({ color: color }));
  ...
  function addLineShape(shape, color, x, y, z, rx, ry, rz, s) {
    ...
    let particles = new Points(
      geometryPoints,
      new PointsMaterial({ color: color, size: 4 })
    );
  ...
  const heartShape = new Shape() // From http://blog.burlock.org/html5/130-paths
    .moveTo(x + 25, y + 25)
