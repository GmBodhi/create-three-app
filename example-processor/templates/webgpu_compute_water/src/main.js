...
function init() {
  ...
  // material: make a ShaderMaterial clone of MeshPhongMaterial, with customized position shader.
  ...
  // Create sphere InstancedMesh
  const sphereGeometry = new SphereGeometry(4, 24, 12);
