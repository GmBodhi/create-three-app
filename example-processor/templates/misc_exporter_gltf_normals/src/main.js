...
function init() {
  ...
  const light2 = new DirectionalLight(0xffffff, 4); // for back-sided objects
  ...
  // textures
  const normalMapOpenGL = new TextureLoader().load(
    "textures/NormalMapOpenGL.png",
    render
  );
  const normalMapDirectX = new TextureLoader().load(
  ...
  // mesh1
  mesh1 = new Mesh(GEOMETRY, material.clone());
  ...
  // mesh2
  mesh2 = new Mesh(GEOMETRY, material.clone());
