...
const uPlaneColor = uniform(new Color(state.plane.color));
...
function init() {
  ...
  depthMaterial = new NodeMaterial();
  ...
  shadowPlaneMaterial = new NodeMaterial();
  ...
  plane = new Mesh(planeGeometry, shadowPlaneMaterial);
  plane.renderOrder = 1;
  plane.scale.y = -1;
  plane.scale.z = -1;
  shadowGroup.add(plane);

  fillPlaneMaterial = new NodeMaterial();
...
function animate() {
  ...
  if (initialClearAlpha !== undefined)
