...
const brushScene = new Scene();

brushScene.background = new Color(0xffffff);
const brushMat = new MeshBasicNodeMaterial();
...
const brushMesh = new Mesh(new PlaneGeometry(1, 1), brushMat);
