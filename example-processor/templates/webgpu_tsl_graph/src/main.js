...
async function initTSLGraph() {
  ...
  const m2 = new MeshStandardNodeMaterial();
  m2.userData.graphId = "mat_2-standard";

  const m3 = new MeshPhongNodeMaterial();
...
async function init() {
  ...
  const plane = new Mesh(new CircleGeometry(40), createGroudMaterial());
...
async function createShaderBall(material, position = new Vector3()) {
