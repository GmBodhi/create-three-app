...
async function init() {
  ...
  const texturePainting1 = await new TextureLoader().loadAsync(
  ...
  const geometryPainting = new PlaneGeometry(100, 100);
  const mesh1 = new Mesh(geometryPainting, materialPainting1);
  const mesh2 = new Mesh(geometryPainting, materialPainting2);
