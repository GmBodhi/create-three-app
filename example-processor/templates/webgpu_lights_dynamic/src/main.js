...
function init() {
  ...
  const sphereGeometry = new SphereGeometry(0.8, 128, 128);
  const boxGeometry = new BoxGeometry(1.2, 1.2, 1.2, 64, 64, 64);
  const torusGeometry = new TorusGeometry(0.6, 0.25, 128, 128);
  const cylinderGeometry = new CylinderGeometry(0.5, 0.5, 1.4, 128, 64);
  const coneGeometry = new ConeGeometry(0.6, 1.4, 128, 64);
...
function addLight() {
  ...
  const light = new PointLight(color, 1000);
