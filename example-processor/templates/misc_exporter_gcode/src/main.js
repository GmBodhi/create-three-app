...
function init() {
  ...
  h.add(params, "infillPattern", ["grid", "triangles", "hexagons"]).name(
    "Infill Pattern"
  );
...
function exportToGCode() {
  try {
    ...
    alert(
      "Note: Polyslice is an external library. Please ensure it is loaded correctly."
    );
  }
}
